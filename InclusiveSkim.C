...
/*	
	...
	for (const auto& entry : fs::directory_iterator("/home/shubham/Graviton/work")) {
...
vector<std::string> inFiles;
	...
	// List of all input folders (change names to match your setup)
	vector<std::string> inputDirs = {
	 
	  "/home/shubham/Graviton/epic/RECO/26.02.0/epic_craterlake/DIS/BeAGLE1.03.02-2.1/eHe3/10x166/q2_2to10", 
	 "/home/shubham/Graviton/epic/RECO/26.02.0/epic_craterlake/DIS/BeAGLE1.03.02-2.1/eHe3/10x166/q2_10to100",
	 "/home/shubham/Graviton/epic/RECO/26.02.0/epic_craterlake/DIS/BeAGLE1.03.02-2.1/eHe3/10x166/q2_100to10000"
	};
	...
	// access remote file
//	vector<std::string> inFiles = {"root://dtn-eic.jlab.org:1094//volatile/eic/EPIC/RECO//25.12.0/epic_craterlake/DIS/BeAGLE1.03.02-1.2/eHe3/10x110/q2_2to10/BeAGLE1.03.02-1.2_DIS_eHe3_10x110_q2_2to10_ab.2277.eicrecon.edm4eic.root"};
...
*/
    	...
    	//	double in_e = 10.0;   // electron beam energy
	//	double in_n = 166.0;  // hadron beam energy
    	
    	//CalculateRealElectronKinematics(in_e, in_n, kprime, algorithm[MC]);

		TLorentzVector ki, P;

		// incoming electron (along -z)
		ki.SetPxPyPzE(0, 0, -Ee, Ee);

		// incoming hadron (along +z)
		P.SetPxPyPzE(0, 0, Eh, sqrt(Eh*Eh + Mp*Mp));

		CalculateRealElectronKinematics(ki, P, kprime, algorithm[MC]);
	...
	//	}
		...
		auto hfsCollection = eFinder->FindHadronicFinalState(
    e_rec.getObjectID().index
);
